...
var Stringifier = SAJJ.createConstructor(ObjectArrayDelegator); // Convenience method to create constructor not requiring new keyword and inheriting from the designated constructor (or SAJJ when not present)
