...
SAJJ.createAndReturn = function createAndReturn (options) {
  const Constructor = options.constructs || SAJJ.createConstructor(options.inherits);
...
SAJJ.createAndExport = function createAndExport (options) {
  const Constructor = SAJJ.createAndReturn(options);
...
if (typeof module !== 'undefined') {
  ...
  const exp = typeof define !== 'undefined' && define.amd ? {} : window;
  exp.SAJJ = SAJJ;
  exp.SAJJ_JS = SAJJ_JS;
